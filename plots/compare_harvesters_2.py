...
from harvester_boost_count import calculate_total_rank
...
def compare_harvester_yield_2harvesters(parts1=20, members1=20, parts2=20, members2=20, atlas_parts=0, debug=True):
    ...
    boost_h1 = total_harvester_boost(num_parts=parts1, num_legions=num_legions1, extractors=[], total_rank=num_legions1)
    boost_h2 = total_harvester_boost(num_parts=parts2, num_legions=num_legions2, extractors=[], total_rank=num_legions2)
    ...
    boost_atlas = total_harvester_boost(num_parts=atlas_parts, num_legions=2000, extractors=[], total_rank=1, is_atlas=True) # 6x boost by default
    if debug:
